...
void arbiter :: func()
{
	...
	{ 
		...
		if (!req0.read()[4]) //if FIFO buffer is not empty 
		{
			...
			if(v_id(1,0) < req0.read()(1,0)) v_req[0]=3; // go to east
			else {	
				if(v_id(1,0) > req0.read()(1,0))v_req[0]=5; //go to west
				else{
					if(v_id(3,2) < req0.read()(3,2))v_req[0]=4; // go to south
					else{
						if(v_id(3,2) > req0.read()(3,2))v_req[0]=2; //go to north
		...
		if (!req1.read()[4]) //if buffer is not empty 
		{
			...
			if(v_id(1,0) < req1.read()(1,0)) v_req[1]=3; // go to east
			else {	
				if(v_id(1,0) > req1.read()(1,0))v_req[1]=5; //go to west
				else {
					if(v_id(3,2) < req1.read()(3,2))v_req[1]=4; // go to south
					else {
						if(v_id(3,2) > req1.read()(3,2))v_req[1]=2; //go to north
		...
		if (!req2.read()[4]) //if buffer is not empty 
		{
			...
			if(v_id(1,0) < req2.read()(1,0)) v_req[2]=3; // go to east
			else {	
				if(v_id(1,0) > req2.read()(1,0))v_req[2]=5; //go to west
				else {
					if(v_id(3,2) < req2.read()(3,2))v_req[2]=4; // go to south
					else {
						if(v_id(3,2) > req2.read()(3,2))v_req[2]=2; //go to north
		...
		if (!req3.read()[4]) //if buffer is not empty 
		{
			...
			if(v_id(1,0) < req3.read()(1,0)) v_req[3]=3; // go to east
			else {	
				if(v_id(1,0) > req3.read()(1,0))v_req[3]=5; //go to west
				else {
					if(v_id(3,2) < req3.read()(3,2))v_req[3]=4; // go to south
					else {
						if(v_id(3,2) > req3.read()(3,2))v_req[3]=2; //go to north
		...
		if (!req4.read()[4]) //if buffer is not empty  
		{
			...
			if(v_id(1,0) < req4.read()(1,0)) v_req[4]=3; // go to east
			else {	
				if(v_id(1,0) > req4.read()(1,0))v_req[4]=5; //go to west
				else {
					if(v_id(3,2) < req4.read()(3,2))v_req[4]=4; // go to south
					else {
						if(v_id(3,2) > req4.read()(3,2))v_req[4]=2; //go to north
