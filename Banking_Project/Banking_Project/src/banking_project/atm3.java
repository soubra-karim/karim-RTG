...
public class atm3 {
    ...
    private PrivateKey privatekeyATM3;
    private PublicKey publicKeyATM3;
    public SecretKey master_secret_key;
    public SecretKey master_secret_key_mac;
    public String id = "atm3";
    public Socket clientSocket;
    public atm3() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException{
        KeyPairGenerator keyGenA = KeyPairGenerator.getInstance("RSA");
        keyGenA.initialize(2048);
        KeyPair pairATM1 = keyGenA.generateKeyPair();
        privatekeyATM3 = pairATM1.getPrivate();
        publicKeyATM3 = pairATM1.getPublic();
        // Save public key A to a file
        File publicKeyFileATM3 = new File("publicATM3.key");
        X509EncodedKeySpec x509EncodedKeySpec = new X509EncodedKeySpec(publicKeyATM3.getEncoded());
        Files.write(publicKeyFileATM3.toPath(), x509EncodedKeySpec.getEncoded());
    }
    ...
    public void gen_keys_authenticate() throws IOException, Exception{
        ...
        message1part1 = decryptpriv(message1part1, privatekeyATM3);
        message1part2 = decryptpriv(message1part2, privatekeyATM3);
        ...
        message3 = decryptpriv(message3, privatekeyATM3);
        ...
        message4part1 = decryptpriv(message4part1, privatekeyATM3);
        message4part2 = decryptpriv(message4part2, privatekeyATM3);
        ...
        message4part1_mac = decryptpriv(message4part1_mac, privatekeyATM3);
        message4part2_mac = decryptpriv(message4part2_mac, privatekeyATM3);
